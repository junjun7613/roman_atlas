        ...
        <div style={{ display: activeTab === 'settings' ? 'block' : 'none' }}>
          ...
          <div className="mb-6">
              ...
              <div id="baseLayersContent" className="pl-4">
                ...
                <label className="flex items-center cursor-pointer mb-2">
                  ...
                  <span className="text-[14px] text-[#555]">Elevation Map</span>
                </label>
              </div>
            </div>
          ...
          <div className="mb-6">
              ...
              <div id="pleiadesContent" className="pl-4">
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleSettlements" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Cities & Settlements</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleVillas" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Villas</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleForts" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Forts</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleTemples" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Temples</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleStations" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Stations</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleArchaeological" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Archaeological Sites</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleCemetery" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Cemeteries</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleSanctuary" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Sanctuaries</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleBridge" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Bridges</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleAqueduct" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Aqueducts</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleChurch" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Churches</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleBath" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Baths</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleQuarry" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Quarries</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="togglePort" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Harbors</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleTheater" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Theaters</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleAmphitheatre" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Amphitheaters</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleResidence" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Residences</span></label>
                <label className="flex items-center cursor-pointer mb-2"><input type="checkbox" id="toggleForum" className="mr-3 cursor-pointer w-4 h-4" /><span className="text-[14px] text-[#555]">Forums</span></label>
              </div>
          </div>
        </div>
          ...
          <div className="text-[16px] text-[#555]">
            {inscriptionData ? (
                ...
                {inscriptionData.type === 'single' ? (
                  <div>
                        ...
                        <div className="flex gap-4 mb-4">
                          ...
                          <div className="flex-1 bg-gray-50 p-4 rounded-lg">
                            ...
                            {inscriptionData.loading ? (
                              ...
                              <p className="text-[14px] text-[#666] mb-0">
                                <strong>Inscriptions Count:</strong> {inscriptionData.count} items
                              </p>
                            )}
                          </div>
                          ...
                          <div className="flex-1 bg-blue-50 p-4 rounded-lg">
                            ...
                            {filterDataLoading ? (
                              ...
                              <p className="text-[12px] text-[#666]">Filter No data available</p>
                            )}
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg mb-4">
                          ...
                          {inscriptionData.mosaicsLoading ? (
                            ...
                            <p className="text-[14px] text-[#666] mb-0">
                              <strong>Mosaics Count:</strong> {inscriptionData.mosaics?.length || 0} items
                            </p>
                          )}
                        </div>
                      </div>
                    ...
                    {infoSubTab === 'inscriptions' && !inscriptionData.loading && inscriptionData.inscriptions && inscriptionData.inscriptions.length > 0 && !networkEdcsId && !networkLoading && !detailViewEdcsId && !detailViewLoading && (
                      <div className="mt-4">
                        <h4 className="text-[16px] font-semibold mb-3 text-[#333]">
                          Inscriptions List ({filteredInscriptions.length} items{selectedFilters.size > 0 || statisticsFilteredEdcsIds.length > 0 ? ` / ${inscriptionData.inscriptions.length} items total` : ''})
                        </h4>
                          ...
                          <div className="mb-3 p-2 bg-blue-50 border border-blue-200 rounded flex items-center justify-between">
                            <div className="text-[13px]">
                              ...
                              <span className="font-medium text-gray-900">
                                ...
                                {statisticsFilter.type === 'divinityType' && `Divinities Type: ${statisticsFilter.value}`}
                                {statisticsFilter.type === 'costRange' && (() => {
                                  if (costFilter.min !== null && costFilter.max !== null) {
                                    return `Cost Range: ${costFilter.min.toLocaleString()} - ${costFilter.max.toLocaleString()} HS`
                                  } else if (costFilter.min !== null) {
                                    return `Cost Range: ${costFilter.min.toLocaleString()} HS or more`
                                  } else if (costFilter.max !== null) {
                                    return `Cost Range: ${costFilter.max.toLocaleString()} HS or less`
                                  }
                                  return ''
                                })()}
                              </span>
                          ...
                          {filteredInscriptions.map((inscription, index) => (
                            ...
                            >
                              ...
                              <p className="text-[11px] text-[#888] mb-2">
                                <strong>Dating:</strong> {inscription.dating && inscription.dating.trim() !== '' ? inscription.dating : '-'}
                              </p>
                              <div className="grid grid-cols-2 gap-1 text-[10px] text-[#666] mb-2">
                                <div><strong>Persons:</strong> {inscription.personCount || 0}</div>
                                <div><strong>Relationships:</strong> {inscription.relationshipCount || 0}</div>
                                <div><strong>Careers:</strong> {inscription.careerCount || 0}</div>
                                <div><strong>Benefaction:</strong> {inscription.benefactionCount || 0}</div>
                              </div>
                              <div className="flex gap-1">
                                ...
                                {inscription.iiifManifest3D && (
                                  <a
                                    ...
                                    title="3DModel Display"
                                    aria-label="3DModel Display"
                                  >
                    ...
                    {infoSubTab === 'mosaics' && !inscriptionData.mosaicsLoading && inscriptionData.mosaics && !networkEdcsId && !networkLoading && (
                      <div className="mt-4">
                        <h4 className="text-[16px] font-semibold mb-3 text-[#333]">
                          MosaicsList ({inscriptionData.mosaics.length} items)
                        </h4>
                        {inscriptionData.mosaics.length > 0 ? (
                          ...
                          <p className="text-[14px] text-[#666]">This location hasMosaicsNo data available</p>
                        )}
                      </div>
                    )}
                        ...
                        {statisticsTab === 'age' && (
                          <div className="mt-4">
                            {ageAtDeathLoading ? (
                              ...
                              <p className="text-[14px] text-[#666]">No data available</p>
                            )}
                          </div>
                        )}
                            ...
                            {benefactionTypeLoading ? (
                              ...
                              <div className="space-y-4">
                                ...
                                {topBenefactionsLoading ? (
                                  ...
                                  <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                                    <p className="text-[13px] font-semibold text-yellow-800 mb-2">High-valueBenefactionsTop10</p>
                      ...
                      {inscriptionData.loading ? (
                        ...
                        <>
                          <p className="text-[14px] text-[#666] mb-4">
                            <strong>Total Inscriptions Count:</strong> {inscriptionData.count} items
                          </p>
                          <p className="text-[14px] text-[#666] mb-2">
                            <strong>Selected locations:</strong> {inscriptionData.places?.length || 0} locations
                          </p>
                              ...
                              >
                                {inscriptionData.places.map((place, index) => (
                                  <option key={index} value={index}>
                                    {place.placeName} ({place.count} items)
                                  </option>
                                ))}
                              </select>
                            </div>
                            ...
                            {benefactionTypeLoading ? (
                              ...
                              <div className="space-y-4">
                                ...
                                {topBenefactionsLoading ? (
                                  ...
                                  <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                                    <p className="text-[13px] font-semibold text-yellow-800 mb-2">High-value Benefactions Top 10</p>
                                    <div className="space-y-1.5 max-h-[300px] overflow-y-auto">
                                      {topBenefactionsData.map((item, index) => (
                                        <div
                                          key={index}
              ...
              <div className="text-[14px] text-[#666]">
                Click on a place name or select a rectangular area to display related Inscriptions Information
              </div>
            )}
          </div>
        </div>
